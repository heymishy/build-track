...
type ProjectAction = StateAction<Project> | 
...
export function ProjectsProvider({ children }: { children: ReactNode }) {
  ...
  const actions: ProjectActions = {
    ...
    getOverBudgetProjects: (): Project[] => {
      return state.entities.filter(project => 
        project.stats?.isOverBudget === true
      )
    },
...
export const projectSelectors = {
  ...
  // Get project by ID
  getById: (state: ProjectState, id: string) => 
    state.entities.find(p => p.id === id),
