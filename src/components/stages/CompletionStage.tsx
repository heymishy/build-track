    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6 border border-green-200">
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Project Completed</h1>
            ...
            <div className="flex items-center space-x-4">
              ...
              {durationDays > 0 && (
                <span className="text-sm text-gray-500">Duration: {durationDays} days</span>
              )}
            </div>
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="p-6">
          ...
          <div
            className={`text-3xl font-bold ${totalVariance >= 0 ? 'text-green-600' : 'text-red-600'}`}
          >
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-green-800">
              <strong>Project Completed:</strong> All documents are now archived and available for
              download. This data will be retained according to your retention policy.
            </p>
          </div>
        </div>
      </div>
