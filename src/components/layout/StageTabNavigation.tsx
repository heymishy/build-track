            ...
            return (
              ...
              >
                <TabIcon 
                  className={`
                    ${isActive 
                      ? currentStage === 'PLANNING' ? 'text-blue-500' :
                        currentStage === 'IN_PROGRESS' ? 'text-orange-500' :
                        currentStage === 'COMPLETED' ? 'text-green-500' :
                        currentStage === 'ON_HOLD' ? 'text-yellow-500' :
                        'text-gray-500'
                ...
                {count !== undefined && count > 0 && (
                  <span className={`
                    ...
                    ${isActive 
                      ? currentStage === 'PLANNING' ? 'bg-blue-100 text-blue-800' :
                        currentStage === 'IN_PROGRESS' ? 'bg-orange-100 text-orange-800' :
                        currentStage === 'COMPLETED' ? 'bg-green-100 text-green-800' :
                        currentStage === 'ON_HOLD' ? 'bg-yellow-100 text-yellow-800' :
